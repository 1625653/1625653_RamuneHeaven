<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Ramune_Heaven.Admin.Edit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:Image ID="currentImage" runat="server" style="width:300px; height:300px;" />
